var n, l, u, t, i, r, o, e, f, c, a, s, h, p, v, y, d = {},
    w = [],
...
function T(n, l, u, t, i) {
    ...
    if (s)
        for (r = 0; r < a; r++) null != (e = u[r]) && 0 == (2 & e.__u) && (e.__e == t && (t = $(e)), K(e, e));
    return t
}
    ...
    n: if ("style" == l)
        if ("string" == typeof u) n.style.cssText = u;
            ...
            if ("string" == typeof t && (n.style.cssText = t = ""), t)
                for (l in t) u && l in u || z(n.style, l, "");
            if (u)
                for (l in u) t && u[l] == t[l] || z(n.style, l, u[l])
        }
...
function q(n, u, t, i, r, o, e, f, c, a) {
    ...
    n: if ("function" == typeof j) {
        ...
        try {
            ...
            p.state = p.__s, null != p.getChildContext && (i = m(m({}, i), p.getChildContext())), M && !v && null != p.getSnapshotBeforeUpdate && (_ = p.getSnapshotBeforeUpdate(y, d)), H = null != s && s.type === S && null == s.key ? E(s.props.children) : s, f = L(n, g(H) ? H : [H], u, t, i, r, o, e, f, c, a), p.base = u.__e, u.__u &= -161, p.__h.length && e.push(p), k && (p.__E = p.__ = null)
        } catch (n) {
...
function G(u, t, i, r, o, e, f, c, a) {
    ...
    if (null == x) m === k || c && u.data == k || (u.data = k);
        ...
        else if (p && (u.innerHTML = ""), L("template" == t.type ? u.content : u, g(v) ? v : [v], t, i, r, "foreignObject" == x ? "http://www.w3.org/1999/xhtml" : o, e, f, e ? e[0] : i.__k && $(i, 0), c, a), null != e)
...
function K(n, u, t) {
    ...
    if (i = n.__k)
        for (r = 0; r < i.length; r++) i[r] && K(i[r], u, t || "function" != typeof n.type);
...
export {
    C as Component, S as Fragment, W as cloneElement, X as createContext, k as createElement, M as createRef, k as h, U as hydrate, t as isValidElement, l as options, R as render, F as toChildArray
};
